...
public:
  ...
  ~BenchmarkNode();
  void tracePose(const SE3d& T_w_f, const double timestamp);
  void tracePoseError(const SE3d& T_f_gt, const double timestamp);
...
void BenchmarkNode::tracePose(const SE3d& T_w_f, const double timestamp)
{
...
void BenchmarkNode::tracePoseError(const SE3d& T_f_gt, const double timestamp)
{
